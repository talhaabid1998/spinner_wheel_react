...
var WheelComponent = function WheelComponent2(_ref) {
  ...
  var wheelInit = function wheelInit2() {
    initCanvas();
    wheelDraw();
  };
  var initCanvas = function initCanvas2() {
    var canvas = document.getElementById("canvas");
    console.log(navigator);
    if (navigator.userAgent.indexOf("MSIE") !== -1) {
      canvas = document.createElement("canvas");
      canvas.setAttribute("width", 1e3);
  ...
  var spin = function spin2() {
    isStarted = true;
    if (timerHandle === 0) {
      spinStart = (/* @__PURE__ */ new Date()).getTime();
      maxSpeed = Math.PI / segments.length;
      frames = 0;
      timerHandle = setInterval(onTimerTick, timerDelay);
    }
  };
  var onTimerTick = function onTimerTick2() {
    frames++;
    draw();
    var duration = (/* @__PURE__ */ new Date()).getTime() - spinStart;
    var progress = 0;
    var finished = false;
    if (duration < upTime) {
  ...
  var wheelDraw = function wheelDraw2() {
    clear();
    drawWheel();
    drawNeedle();
  };
  ...
  var drawSegment = function drawSegment2(key, lastAngle, angle) {
  ...
  var drawWheel = function drawWheel2() {
    var ctx = canvasContext;
  ...
  var drawNeedle = function drawNeedle2() {
    var ctx = canvasContext;
    ctx.lineWidth = 1;
    ctx.strokeStyle = contrastColor;
...
var index_modern_default = WheelComponent;
export {
  index_modern_default as default
};
//# sourceMappingURL=react-wheel-of-prizes.js.map
